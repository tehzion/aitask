...
insert into public.aitask_members(
  ...
  ('pgtap-role-admin', 'pgtap-role-templates', '00000000-0000-0000-0000-000000000921', 'Admin', 'pgtap-role-admin@aitask.local', 'Admin', 'Management', array['Management'], false, null, '{}'::jsonb),
  ('pgtap-role-hod', 'pgtap-role-templates', '00000000-0000-0000-0000-000000000922', 'HOD', 'pgtap-role-hod@aitask.local', 'Staff', 'Designer', array['Designer'], false, 'system-hod', '{}'::jsonb),
  ('pgtap-role-boss', 'pgtap-role-templates', '00000000-0000-0000-0000-000000000923', 'Boss', 'pgtap-role-boss@aitask.local', 'Admin', 'Management', array['Management'], true, null, '{}'::jsonb),
...
-- Admin gains the full operational surface, including Approvals and company management.
select set_config('request.jwt.claim.sub', '00000000-0000-0000-0000-000000000921', true);
select set_config('request.jwt.claim.role', 'authenticated', true);
select is(private.aitask_has_permission('pgtap-role-templates', 'viewApprovals'), true, 'Admin can access Approvals');
select is(private.aitask_has_permission('pgtap-role-templates', 'createClients'), true, 'Admin can add companies server-side');
