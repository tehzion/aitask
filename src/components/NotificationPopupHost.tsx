...
const NotificationPopupCard: React.FC<NotificationPopupCardProps> = ({
  ...
  return (
    <article
      ...
      className="pointer-events-auto overflow-hidden rounded-lg border border-slate-200 bg-white shadow-xl shadow-slate-950/15 animate-in fade-in slide-in-from-left-3 slide-in-from-bottom-2"
    >
