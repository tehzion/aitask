...
export const Button: React.FC<ButtonProps> = ({ className, variant = 'primary', type = 'button', ...props }) => (
  <button
    ...
    className={cn(
      buttonBase,
      'min-h-10 px-4 py-2',
      variant === 'primary'   && 'bg-blue-700 text-white shadow-[0_1px_2px_rgba(15,23,42,0.12)] hover:bg-blue-800 active:bg-blue-900',
      variant === 'secondary' && 'border border-slate-300 bg-white text-slate-700 shadow-[0_1px_1px_rgba(15,23,42,0.03)] hover:border-slate-400 hover:bg-slate-50',
  ...
  <div className={cn(cardBase, 'p-4 sm:p-5', className)}>
    <div className="flex items-start justify-between gap-3">
      <div className="min-w-0">
        ...
        <div className="mt-1.5 text-2xl font-semibold leading-8 text-slate-950">{value}</div>
      </div>
